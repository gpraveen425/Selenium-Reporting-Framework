...
/*		System.out.println(countA);
		...
		htmlmain += "<html><head><link rel=\"stylesheet\" href=\"https://sites.google.com/site/seleniumworks/srf/style.css\" type=\"text/css\">"
				...
				+ "var data2 = google.visualization.arrayToDataTable([['Timeline', '', 'FAIL', 'SKIP', 'PASS'], ['STATS', 0,    20,    5,   50]]);"
				...
				+ "var chart2 =   new google.visualization.BarChart(document.getElementById('barchart_3d')).draw(data2, {title:\"Selenium Bar Chart Report\", width:700, height:300,"
					+ "bar: { groupWidth: '200%' },vAxis: {title: \"Timeline\"},hAxis: {title: \"Test Count\"}});"
				+ "}</script>"
