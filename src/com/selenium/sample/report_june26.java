	...
	public static void Generatereport(int r) throws IOException {
		...
		for (int i = 0; i <= r; i++) {
			if (op.get(i).equals(exp.get(i))) {
				res.add(i, "<td style='background-color: green;'>PASS</td>");
				countP++;
			}

			else {
				res.add(i, "<td style='background-color: red;'>FAIL</td>");
				countF++;
			}
		}
		...
		for (int i = 0; i <= r; i++) {
			html += "<tr> <td>" + ip.get(i) + "</td> <td>" + exp.get(i)
					+ "</td> <td>" + op.get(i) + res.get(i)
					+ "</td> </tr>";
			countA++;
		}		

		re = (countP * 100 / countA);
		htmlresult += "<tr><td>" + countP + "</td> <td>" + countF
				+ "</td> <td>" + re + "</td></tr>";


//		System.out.println(Utils.SPECIAL_CHARACTERS);
...
/*		System.out.println(countA);
		...
		htmlmain += "<html><head><link rel=\"stylesheet\" href=\"https://sites.google.com/site/seleniumworks/srf/style.css\" type=\"text/css\">"
				...
				+ "><table class="
				+ "zebra"
				+ "><caption>Selenium Reporting Framework - Test Results</caption> <tbody id=summary><tr><td>PASSED</td> <td>FAILED</td> <td>PASS %</td></tr><tr>$summary</tr></table></div>" 
				+"<input type=\"button\" name=\"barchart\" id=\"barchart\" value=\"barchart\" onClick=\"clickBar()\" style=\"width: 150px; height: 40px; float: right; -webkit-border-radius: 5px; box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.4), 0 1px 1px rgba(0, 0, 0, 0.2);\"/>"				
				+"<input type=\"button\" name=\"piechart\" id=\"piechart\" value=\"piechart\" onClick=\"clickPie()\" style=\"width: 150px; height: 40px; float: left; -webkit-border-radius: 5px; box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.4), 0 1px 1px rgba(0, 0, 0, 0.2);\"/>"				

				+ "<div id=\"piechart_3d\" style=\"width: 750px; height: 350px;\"></div>"+"<div id=\"barchart_3d\" style=\"width: 750px; height: 350px;display:none;\"></div>"
				+"<div><p>Detailed Report</p></div>"+"<table class="
				+ "zebra"
				+ ">"				
				+ "<tbody id="
				+ "theBody"				
				...
				+ "<div id=\"cookie-info\" style=\"opacity: 1; display: block;\"><strong> Next Generation Reports:</strong> 2014 Seleniumworks <a id=\"tellmemore\" href=\"http://www.seleniumworks.com\">Blogger</a><div id=\"cookie-close\">SRF</div>"				
				+ "</body>	</html>";
		String htmlw = "";
