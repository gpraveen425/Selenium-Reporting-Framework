...
public class report {
	...
	public static void Generatereport(int r) throws IOException {
		...
		htmlmain += "<html><head><title>SRF Report</title><style>html, body{padding:0;margin:0;position:relative;	background-repeat:repeat;	color:#000;	letter-spacing:1px;	font-family:Georgia, "
				+ "Times New Roman"
				...
				+ "><table class="
				+ "zebra"
				+ "><caption>Selenium Reporting Framework - Test Results</caption> <tbody id=summary><tr><td>No. Of Test Passed</td> <td>No. Of Test Failed</td> <td>Pass %</td></tr><tr>$summary</tr></table></div> <table class="
				+ "zebra"
				+ "><tbody id="
				+ "theBody"
