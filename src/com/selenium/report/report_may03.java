...
/*		System.out.println(countA);
		...
		htmlmain += "<html><head><link rel=\"stylesheet\" href=\"https://sites.google.com/site/seleniumworks/srf/style.css\" type=\"text/css\">"
				...
				+ "var options = {title: 'Selenium Pie Chart Report', is3D: true,};var chart = new google.visualization.PieChart(document.getElementById('piechart_3d'));chart.draw(data, options);}</script>"				
