...
public class Reporter {
	...
	public static void Generatereport(int r) throws IOException {
		...
		htmlmain += "<html><head><title>Test Results</title><style>html, body{padding:0;margin:0;position:relative;	background-repeat:repeat;	color:#000;	letter-spacing:1px;	font-family:Georgia, "
				+ "Times New Roman"
				...
				+ "><table class="
				+ "zebra"
				+ "><caption>The generated ultimate Test Results.</caption> <tbody id=summary><tr><td>No. Of Test Passed</td> <td>No. Of Test Failed</td> <td>Pass %</td></tr><tr>$summary</tr></table></div> <table class="
				+ "zebra"
				+ "><tbody id="
				+ "theBody"
				+ "><tr> <td>Input</td> <td>Expected Output</td> <td>Output</td> <td>Result</td> </tr>$body </tbody></table><p><a style="
				+ "color:#000000;"
				+ ">Copyrights @Suresh Kumar -</a> <a href="
				+ "http://qualityassure.blogspot.in"
				+ "> Blogger</a></p></body>	</html>";
